...
// CONCATENATED MODULE: ./src/static/js/app.js
...
$(() => {
  ...
  gsapWithCSS.to('.level-1', {
    opacity: 1,
    duration: .1
  });
  gsapWithCSS.to('.level-2', {
    opacity: 1,
    left: -10,
    top: 10,
    duration: .25,
  ...
  let classname = document.getElementsByClassName("send-btn"); // for (var i = 0; i < classname.length; i++) {
